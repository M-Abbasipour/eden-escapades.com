	...
	if(isset($_SESSION['username']) && isset($_SESSION['password']) || isset($_COOKIE['username']) && isset($_COOKIE['password'])) {	
		...
		if($verify['username']) {
			...
			if($_GET['b'] == 'security') {
				...
				if($userSettings['gender'] == '1') {
					$TMPL['fgender'] = 'selected="selected"';
				} elseif($userSettings['gender'] == '2') {
					$TMPL['mgender'] = 'selected="selected"';
				} elseif($userSettings['gender'] == '3') {
					$TMPL['cplgender'] = 'selected="selected"';
				} elseif($userSettings['gender'] == '4') {
					$TMPL['tvtsgender'] = 'selected="selected"';
				}
