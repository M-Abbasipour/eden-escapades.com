...
$LNG['success'] = 'Success';
$LNG['invalid_gender'] = 'Please select a gender';
$LNG['invalid_user_pw'] = 'Invalid username or password';
$LNG['invalid_captcha'] = 'Invalid captcha';
$LNG['invalid_invite'] = 'Invalid invite code';
$LNG['empty_invite'] = 'Please enter a unique invite code';
...
//$LNG['welcome_img'] = '<div id="welcome-logo"><img src="../Script/img/EELogo.png"></div>';
$LNG['welcome_title'] = 'Welcome';
$LNG['welcome_desc'] = 'to Eden Escapades';
$LNG['welcome_about'] = '21st century dating for the daring and devilish...';
...
$LNG['sidebar_couple'] = 'Couple';
$LNG['sidebar_tvts'] = 'TV/TS';
...
$LNG['pages_created'] = 'Pages Created';
...
$LNG['pages'] = 'Pages';
$LNG['photos'] = 'Photos';
$LNG['search_for_people'] = 'search people, #hashtags, @pages, !groups';
...
$LNG['time'] = 'GMT: ' . date('H:i', time()-3600);
